package com.example.demo.infrastructure.redis.impl

import com.example.demo.core.board.domain.Board
import com.example.demo.core.board.port.BoardReader
import com.example.demo.infrastructure.redis.entity.BoardEntity
...
class BoardReaderImpl(private val om: ObjectMapper, private val template: StringRedisTemplate) : BoardReader {
    override fun readById(id: UUID): Board? = template.opsForValue().get(id.toString())?.let { om.readValue(it, BoardEntity::class.java) }?.toDomain()
